...
console.log(text.replace(/Manuel Marques de Sousa/, 'Julyemerson Bento Leonizio'))
...
var regexDate = /\d/g
var anos = text.match(/(\d\d)(\d\d)/g)
var dias = text.match(/(\d de)/g)
var junho = text.match(/(de junho)/g)
var julho = text.match(/(de julho)/g)
